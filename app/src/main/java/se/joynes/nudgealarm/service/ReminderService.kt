...
import se.joynes.nudgealarm.database.NagRepository
...
class ReminderService : Service() {
    ...
    companion object {
        const val ACTION_START = "se.joynes.nudgealarm.ACTION_START"
        const val ACTION_STOP = "se.joynes.nudgealarm.ACTION_STOP"
        const val ACTION_RELOAD = "se.joynes.nudgealarm.ACTION_RELOAD"
        const val ACTION_DONE_FROM_UI = "se.joynes.nudgealarm.ACTION_DONE_FROM_UI"
        const val ACTION_DONE_ALL_FROM_UI = "se.joynes.nudgealarm.ACTION_DONE_ALL_FROM_UI"
        const val ACTION_SNOOZE_FROM_UI = "se.joynes.nudgealarm.ACTION_SNOOZE_FROM_UI"
        const val ACTION_CANCEL_FROM_UI = "se.joynes.nudgealarm.ACTION_CANCEL_FROM_UI"
        const val ACTION_CANCEL_ALL_FROM_UI = "se.joynes.nudgealarm.ACTION_CANCEL_ALL_FROM_UI"
        const val ACTION_REFRESH_NOTIFICATION = "se.joynes.nudgealarm.ACTION_REFRESH_NOTIFICATION"
